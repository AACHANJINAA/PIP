...
DebugCollisionBox::DebugCollisionBox(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, XMFLOAT4 color)
{
	...
	// 1. 올바른 타입의 정점 데이터를 임시 벡터에 생성
	std::vector<IlluminatedVertex> temp_vertices(8);
	temp_vertices[0] = IlluminatedVertex(XMFLOAT3(-0.5f, -0.5f, -0.5f), XMFLOAT3(0, 0, 0), XMFLOAT2(0, 0),color);
	temp_vertices[1] = IlluminatedVertex(XMFLOAT3(-0.5f, 0.5f, -0.5f), XMFLOAT3(0, 0, 0), XMFLOAT2(0, 0),color);
	temp_vertices[2] = IlluminatedVertex(XMFLOAT3(0.5f, 0.5f, -0.5f), XMFLOAT3(0, 0, 0), XMFLOAT2(0, 0),color);
	temp_vertices[3] = IlluminatedVertex(XMFLOAT3(0.5f, -0.5f, -0.5f), XMFLOAT3(0, 0, 0), XMFLOAT2(0, 0),color);
	temp_vertices[4] = IlluminatedVertex(XMFLOAT3(-0.5f, -0.5f, 0.5f), XMFLOAT3(0, 0, 0), XMFLOAT2(0, 0),color);
	temp_vertices[5] = IlluminatedVertex(XMFLOAT3(-0.5f, 0.5f, 0.5f), XMFLOAT3(0, 0, 0), XMFLOAT2(0, 0),color);
	temp_vertices[6] = IlluminatedVertex(XMFLOAT3(0.5f, 0.5f, 0.5f), XMFLOAT3(0, 0, 0), XMFLOAT2(0, 0),color);
	temp_vertices[7] = IlluminatedVertex(XMFLOAT3(0.5f, -0.5f, 0.5f), XMFLOAT3(0, 0, 0), XMFLOAT2(0, 0),color);
...
{
	// 1. 입력받은 Vertex 데이터를 IlluminatedVertex 데이터로 변환하여 임시 벡터에 저장
	...
	for (const auto& v : vertices)
	{
		...
		iv._normal = XMFLOAT3(0, 0, 0);
		iv._texCoord = XMFLOAT2(0, 0);
		iv._diffuse = color;
		temp_vertices.emplace_back(iv);
	}
