...
void CGameFramework::BuildObjects()
{
	...
	m_pScene = new CChess_Scene(m_pd3dDevice,m_pd3dCommandList);
...
{
	m_pScene->ProcessInput(m_GameTimer.GetTimeElapsed(),m_hWnd,m_nMessageID, m_ptOldCursorPos);
}

void CGameFramework::AnimateObjects()
{
	if (m_pScene) m_pScene->AnimateObjects(m_GameTimer.GetTimeElapsed(),m_pd3dCommandList);
}
