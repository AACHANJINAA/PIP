...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/MSI/Documents/GitHub/PIP/00_PIP_BeginningOfLegend_Project/_deps/joltphysics-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/MSI/Documents/GitHub/PIP/00_PIP_BeginningOfLegend_Project/_deps/joltphysics-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
